...
ALTER TABLE Ownership ADD CONSTRAINT FK_User_Ownership FOREIGN KEY (UserID) REFERENCES RMA_User(UserID) ON DELETE CASCADE;
ALTER TABLE Ownership ADD CONSTRAINT FK_Event_Ownership FOREIGN KEY (EventID) REFERENCES Event(EventID) ON DELETE CASCADE;
